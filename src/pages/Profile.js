...
function Profile() {
    ...
    return (
        <Dashboard >
          ...
          <div style={{flex:'33%'}} >         
           <div style={{ marginTop: '8%', width: '80%', backgroundColor: 'white', boxShadow: '0px 0px 10px 5px rgba(0,0,0,0.25)' }} onClick={()=>details('personal')}>
              <div style={{display:'flex'}} >
                  <div style={{flex:'40%'}}>
          ...
          <div style={{display:'flex'}}>
            ...
            <div style={{flex:'66%'}}>
            <div style={{ marginTop: '8%', width: '91%', backgroundColor: 'white', boxShadow: '0px 0px 10px 5px rgba(0,0,0,0.25)' }}>
              { selectedMenu == 'company' ?
              <div style={{paddingLeft:15,paddingTop:14,paddingBottom:12}}>
